...
int main()
{
	int64_t n, m, limitasus= -1 , limitajos = 0, limitastanga = 999, limitadreapta = 0;
	...
	cout << limitajos - limitasus+1 << " " << limitadreapta - limitastanga+1 << "\n";
	for (int i = limitasus; i <= limitajos; i++) {
		for (int j = limitastanga ; j <= limitadreapta; j++) {
			cout << b[i][j] << " ";
		}
		cout << "\n";
	}
