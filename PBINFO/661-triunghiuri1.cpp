...
/// vrem sa returnam indicele i care are ca proprietate ca v[i] < x si v[i] este maxim 
...
int main()
{
	int64_t n, x = -1, cautator = 0, combinari = 0, cateCombinari = 0, ceva = 1;
